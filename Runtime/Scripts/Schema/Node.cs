...
namespace GLTFast.Schema
{
    ...
    public abstract class NodeBase : NamedObject
    {
        ...
        /// If you inherit a custom Node class (for use with a custom <see cref="GltfImportBase&lt;TRoot&gt;"/>
        /// subclass) you can override this method to perform sanity checks on the deserialized, custom properties.
        /// </summary>
