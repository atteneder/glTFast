...
{
    [Obsolete("Use Unity.Cloud.Gltfast.Objects.OcclusionTextureInfo instead.")]
    [MovedFrom(true, sourceNamespace: "GLTFast.Newtonsoft.Schema", sourceAssembly: "glTFast.Newtonsoft")]
    public class OcclusionTextureInfo : Unity.Cloud.Gltfast.Objects.OcclusionTextureInfo, IJsonObject
    {
        /// <inheritdoc/>
